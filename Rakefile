...
temp_root = ENV['SHORT_ATTENTION_SPAN_DOCBOOK_PATH'] || "/Users/wgzhao/workspace/docbook"
...
task :preprocess do
  ...
  # ENV["TEMP_FILE"] = book.tmp  - The file without the .xml extension, useful 
  ...
  # plan to manipulate the Docbook XML.
