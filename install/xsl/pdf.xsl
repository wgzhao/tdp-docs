...
<xsl:param name="body.font.family">Songti</xsl:param>
<xsl:param name="monospace.font.family">Songti</xsl:param>
<xsl:param name="title.font.family">Songti</xsl:param>
